...
offers a `Application` class used to represent the running application. `quak.web`'s `io.john.amiscaray.quak.web.application.WebApplication` extends this class to implement web-specific functionality. This is used to configure 
