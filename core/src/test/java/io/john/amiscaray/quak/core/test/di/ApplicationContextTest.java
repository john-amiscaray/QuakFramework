package io.john.amiscaray.quak.core.test.di;
...
import io.john.amiscaray.quak.core.test.di.stub.*;
import io.john.amiscaray.quak.core.test.di.stub.pojo.*;
...
public class ApplicationContextTest {
    ...
    public void testAggregateListOfEmployeeFromEmployeeStartupDependencyProvider() {
        ...
        MatcherAssert.assertThat(
                ...
                Matchers.contains(MockEmployee.mockEmployee())
        );
